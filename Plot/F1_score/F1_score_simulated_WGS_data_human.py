# -*- coding: utf-8 -*-
"""
Created on Sun Jul 28 11:31:22 2024
...
human_data = human_data.drop(columns=['sample'])
...
plt.tight_layout()
plt.savefig('D:/My_WorkSpace/fig/F1分数-修正/WGS模拟-human.tiff', format='tiff', dpi=300)
plt.show()
